...
<svelte:head>
	<title>Warehouse Operations - West Sound Roller Derby</title>
	<meta
		name="description"
		content="Manage and view warehouse inventory for West Sound Roller Derby. Create new items, add amounts, upload images, and edit existing items."
	/>
	<meta
		name="keywords"
		content="roller derby, West Sound, warehouse operations, manage inventory, view items, create items, add amounts, upload images, edit items"
	/>
	<meta property="og:title" content="Warehouse Operations - West Sound Roller Derby" />
	<meta
		property="og:description"
		content="Manage and view warehouse inventory for West Sound Roller Derby. Create new items, add amounts, upload images, and edit existing items."
	/>
	<meta property="og:image" content="/path/to/your/image.jpg" />
	<meta property="og:url" content="https://www.yourwebsite.com/warehouse-operations" />
